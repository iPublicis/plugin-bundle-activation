...
* Before reporting a bug or suggesting an improvement, please check the `master` branch to see if it has already been addressed.
...
Before reporting a bug or new feature, please check the `master` branch to see if it's already been addressed.

* In your forked repository, create a topic branch for your upcoming patch. Usually this is based on the `master` branch.
...
* Open a pull request to the original repository and choose the correct original branch (probably `master`) you want to patch.
...
[issue ticket]: https://github.com/iPublicis/plugin-bundle-activation/issues
[reviewmerge]: https://github.com/iPublicis/plugin-bundle-activation/issues
